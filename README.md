...
* 尝试了使用textrank提取两个query中的keyword及其pr值，然后设计公式来使两个query的（keyword，pr）二元组列表交互来产生特征，效果也很一般。也尝试过一些其他[chip2019 top1解决方案](https://zhuanlan.zhihu.com/p/97227793)中的特征，都不太好。
